          ...
          <div className="flex items-center gap-2">
            ...
            <span
              className={cn(
                ...
                product.stockStatus === 'out_of_stock' && 'text-red-500 bg-red-500/5 border-red-500/10',
                product.stockStatus === 'low_stock' && 'text-amber-500 bg-amber-500/5 border-amber-500/10',
                product.stockStatus === 'in_stock' && 'text-emerald-500 bg-emerald-500/5 border-emerald-500/10'
              )}
            >
