    ...
    <div className="mx-auto max-w-4xl space-y-8 p-4 md:p-8 animate-in fade-in duration-500">
        ...
        {!isDesktop && (
          <>
            ...
            <p className="text-muted-foreground max-w-lg mx-auto">
              Manage your e-commerce operations on the go. Download our native application for iOS
              and Android devices.
            </p>
          </>
        )}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="relative overflow-hidden rounded-3xl border border-border/50 bg-card/60 p-8 text-center backdrop-blur-sm transition-all hover:border-primary/20 hover:shadow-xl hover:shadow-primary/5">
          ...
          <p className="text-[11px] text-muted-foreground mt-4">Requires Android 8.0 or later</p>
        </div>
        ...
        <div className="relative overflow-hidden rounded-3xl border border-border/50 bg-card/60 p-8 text-center backdrop-blur-sm transition-all hover:border-primary/20 hover:shadow-xl hover:shadow-primary/5">
          ...
          <button
            onClick={() =>
              alert('iOS App Store submission is pending. TestFlight link will be available soon.')
            }
          ...
          <p className="text-[11px] text-muted-foreground mt-4">Requires iOS 13.0 or later</p>
        </div>
      </div>
    </div>
  );
